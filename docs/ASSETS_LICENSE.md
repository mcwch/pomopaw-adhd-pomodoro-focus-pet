...
The PomoPaw source code is MIT licensed. That license does not automatically grant reuse rights for every image in this repository.
...
2. an asset with a compatible open license and attribution recorded here;
3. a generated asset whose provider terms permit repository distribution, with the generation record retained privately;
