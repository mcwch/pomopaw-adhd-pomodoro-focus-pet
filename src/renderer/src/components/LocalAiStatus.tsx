...
function LocalAiStatus(): React.JSX.Element {
  ...
  return <aside className="local-ai-status"><strong>Optional local AI is not set up yet.</strong><span>PomoPaw works without it. To add private task help later, install Ollama and run <code>ollama run qwen2.5:3b</code>.</span></aside>
}
